...
public sealed class DeleteSectionCommandHandler : ICommandHandler<DeleteSectionCommand, ApiResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new ForbiddenException("You are not authorized to delete this curriculum section.");
        }
        ...
        return ApiResponse.Ok("Curriculum section deleted successfully.");
    }
}
