...
{:else}
	<div class="glass-card max-w-lg mx-auto p-12 text-center rounded-3xl border border-warning/30 space-y-4 my-8">
		...
		<div class="space-y-1">
			<h2 class="text-xl font-bold text-base-content">Proctor Console Restricted</h2>
			<p class="text-xs text-base-content/60">
				This area requires Proctor or Administrator credentials to supervise live examinations.
			</p>
		</div>
